...
export function BluffOrTruthStage({
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className={`flex min-h-0 flex-1 flex-col select-none ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
          style={{
            x,
            rotate,
        ...
        >
          {/* Image card only — centered, rounded */}
          ...
          {/* Full-width app stuff: author, claim, controls */}
